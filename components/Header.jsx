    ...
    <header className="fixed z-50 w-screen h-20 p-3 px-4 md:p-5 md:px-16 bg-zinc-950">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-lg font-bold text-orange-600 hover:text-orange-900 duration-100 transition-all ease-in-out cursor-pointer">
              Home
            </li>
            <li onClick={() =>window.location.href = "http://localhost:3000/products"}
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "khanhbatha@gmail.com" || user.email=== "23560056@gm.uit.edu.vn" && (
                  <Link to={"/createItem"}>
                    <p
        ...
        <div className="relative">
          ...
          {isMenu && (
            <motion.div
              ...
              className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0"
            >
              {user && user.email === "khanhbatha@gmail.com" && (
                <Link to={"/createItem"}>
